...
sigma4 <- list(matrix(c(0.03, 0, 0, 0, 0.02, 0, 0, 0, 0.033), nrow = 3),
               matrix(c(0.028, 0, 0, 0, 0.018, 0, 0, 0, 0.025), nrow = 3),
               matrix(c(0.004, 0, 0, 0, 0.003, 0, 0, 0, 0.004), nrow = 3),
               matrix(c(0.015, 0, 0, 0, 0.013, 0, 0, 0, 0.018), nrow = 3))
gamma4 <- matrix(c(
  0.85, 0.05, 0.05, 0.05,
  0.05, 0.85, 0.05, 0.05,
  0.01, 0.01, 0.97, 0.01,
...
phi4 <- list(matrix(c(-0.37, 0, 0, 0, -0.46, 0, 0, 0, -0.47), nrow = 3),
             matrix(c(-0.33, 0, 0, 0, -0.34, 0, 0, 0, -0.36), nrow = 3),
             matrix(c(-0.14, 0, 0, 0, -0.14, 0, 0, 0, -0.12), nrow = 3),
             matrix(c(-0.21, 0, 0, 0, -0.23, 0, 0, 0, -0.25), nrow = 3))
delta4 <- c(1/4, 1/4, 1/4, 1/4)

start_time <- Sys.time()
mean_dynamic_mle4 <- mar_hmm_mle(obs, m = 4, q = 1, k = 3,
...
mean_dynamic_mle4
save(mean_dynamic_mle4, file = "BigDaddy_3Apr17_mean_dynamic_mle4.RData")
load("BigDaddy_3Apr17_mean_dynamic_mle4.RData")
mean_dynamic_pr4 <- mar_hmm_pseudo_residuals(obs, mean_dynamic_mle4,
                                        "forecast",
                                        stationary = FALSE)
mean_dynamic_pr_plot4 <- pseudo_residual_plot(mean_dynamic_pr4)
ggsave("mean_dynamic_pr_plot4.png", mean_dynamic_pr_plot4)
mean_dynamic_decoding4 <- mar_hmm_viterbi(obs, mean_dynamic_mle4)
...
mu4 <- list(c(-0.36, -0.89, 0.08),
            ...
            c(-0.42, -0.88, -0.03),
            c(-0.41, -0.87, -0.02))
sigma4 <- list(matrix(c(0.12, 0, 0, 0, 0.06, 0, 0, 0, 0.17), nrow = 3),
               matrix(c(0.13, 0, 0, 0, 0.07, 0, 0, 0, 0.16), nrow = 3),
               matrix(c(0.07, 0, 0, 0, 0.04, 0, 0, 0, 0.1), nrow = 3),
               matrix(c(0.08, 0, 0, 0, 0.13, 0, 0, 0, 0.18), nrow = 3))
gamma4 <- matrix(c(
  0.85, 0.05, 0.05, 0.05,
  0.05, 0.85, 0.05, 0.05,
  0.01, 0.01, 0.97, 0.01,
...
phi4 <- list(matrix(c(0.96, 0, 0, 0, 0.93, 0, 0, 0, 0.98), nrow = 3),
             matrix(c(0.94, 0, 0, 0, 0.96, 0, 0, 0, 0.97), nrow = 3),
             matrix(c(1, 0, 0, 0, 0.96, 0, 0, 0, 1), nrow = 3),
             matrix(c(0.97, 0, 0, 0, 0.9, 0, 0, 0, 0.99), nrow = 3))
delta4 <- c(1/4, 1/4, 1/4, 1/4)

start_time <- Sys.time()
mean_static_mle4 <- mar_hmm_mle(obs, m = 4, q = 1, k = 3,
                                mu4, sigma4, gamma4, phi4, delta4,
                                stationary = FALSE, hessian = TRUE
)
end_time <- Sys.time()
...
load("BigDaddy_3Apr17_mean_static_mle4.RData")
mean_static_pr4 <- mar_hmm_pseudo_residuals(obs, mean_static_mle4,
                                            "forecast",
                                            stationary = FALSE)
mean_static_pr_plot4 <- pseudo_residual_plot(mean_static_pr4)
ggsave("mean_static_pr_plot4.png", mean_static_pr_plot4)
mean_static_decoding4 <- mar_hmm_viterbi(obs, mean_static_mle4)
