...
log_sd_dynamic_pr4 <- inmar_hmm_pseudo_residuals(obs, log_sd_dynamic_mle4,
...
log_sd_static_pr4 <- inmar_hmm_pseudo_residuals(obs, log_sd_static_mle4,
                                              "forecast",
                                              stationary = FALSE)
log_sd_static_pr_plot4 <- pseudo_residual_plot(log_sd_static_pr4)
ggsave("BigDaddy_3Apr17_log_sd_static_pr_plot4.png", log_sd_static_pr_plot4)
